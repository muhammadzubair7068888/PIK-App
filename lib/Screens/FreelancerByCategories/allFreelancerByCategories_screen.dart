...
class AllFreelancerByCategoriesScreen extends StatefulWidget {
  ...
  final String email;
  const AllFreelancerByCategoriesScreen({
    Key? key,
  ...
  @override
  _AllFreelancerByCategoriesScreenState createState() =>
      _AllFreelancerByCategoriesScreenState();
}

class _AllFreelancerByCategoriesScreenState
    extends State<AllFreelancerByCategoriesScreen> {
  ...
  Future<List<FreelancerModel>> getData(filter) async {
    ...
    var response = await Dio().get(
      baseURL + "freelancer/Category/all",
