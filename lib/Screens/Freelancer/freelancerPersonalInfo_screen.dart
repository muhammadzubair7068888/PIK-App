...
import '../Seeker/seekerIndivPersonalInfo_screen.dart';
import 'freelancerHomePage_screen.dart';

class FreelancerPersonalInfoScreen extends StatefulWidget {
  final String email;
  const FreelancerPersonalInfoScreen({
    Key? key,
    required this.email,
  }) : super(key: key);

  @override
  _FreelancerPersonalInfoScreenState createState() =>
      _FreelancerPersonalInfoScreenState();
}

class _FreelancerPersonalInfoScreenState
    extends State<FreelancerPersonalInfoScreen> {
