...
import 'seeker_model.dart';

class AllSeekerScreen extends StatefulWidget {
  ...
  @override
  State<AllSeekerScreen> createState() => _AllSeekerScreenState();
}

class _AllSeekerScreenState extends State<AllSeekerScreen> {
  ...
  Future getSeekers() async {
    ...
    var url = Uri.parse(baseURL + 'seeker/field/all');
              ...
              ? Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: DropdownSearch<SeekerModel>(
                        onChanged: (value) {
                          sID = value!.id;
                          Navigator.push(
                            context,
  ...
  Future<List<SeekerModel>> getData(filter) async {
    String? token = await storage.read(key: "token");
    var response = await Dio().get(
      baseURL + "seeker/field/all",
    ...
    if (data != null) {
      return SeekerModel.fromJsonList(data);
    }
