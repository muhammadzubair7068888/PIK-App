...
import 'appliedProjectModel.dart';
import 'projectDetails_screen.dart';

class My_Projects_List extends StatefulWidget {
  ...
  @override
  _My_Projects_ListState createState() => _My_Projects_ListState();
}
          ...
          () {
            ...
            for (var i = 0; i < jsonData["data"].length; i++) {
              rows.add(
                Card(
                  child: InkWell(
                    onTap: data[i]["status"] == 0
                        ? () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                                    SeekerProjectDetailsScreen(
                                  seekProj_id: data[i]["project_id"],
                                  email: widget.email,
