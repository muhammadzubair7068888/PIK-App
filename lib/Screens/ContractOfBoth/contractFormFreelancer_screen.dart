...
class ContractFormFreelancerScreen extends StatefulWidget {
  ...
  const ContractFormFreelancerScreen({
    Key? key,
    required this.email,
  ...
  @override
  State<ContractFormFreelancerScreen> createState() =>
      _ContractFormFreelancerScreenState();
}

class _ContractFormFreelancerScreenState
    extends State<ContractFormFreelancerScreen> {
  ...
  Future savePressed() async {
    ...
    // );
    var uri = Uri.parse(baseURL + 'contract/second-party');
    ...
    if (widget.contract_id != null) {
      ...
      request.fields['seeker_id'] = free_id.toString();
      request.fields['name'] = name;
      request.fields['country'] = _country;
      request.fields['city'] = _city;
      request.fields['full_name'] = _name;
    ...
    if (response.statusCode == 200) {
      ...
      _showTopFlash("#60B781", "Contract sent successfully");
      // showTopSnackBar(
      //   context,
                      ...
                      child: widget.contract_id == null
                          ? DropdownSearch<UserModel>(
                              ...
                              dropdownDecoratorProps:
                                ...
                                labelText: "Select Business/Individual",
                                hintText: "Select Business/Individual",
                              )),
