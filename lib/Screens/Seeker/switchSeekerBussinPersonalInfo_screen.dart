...
class SwitchSeekerBussinPersonalInfoScreen extends StatefulWidget {
  final String email;
  const SwitchSeekerBussinPersonalInfoScreen({
    Key? key,
    required this.email,
  }) : super(key: key);

  @override
  _SwitchSeekerBussinPersonalInfoScreenState createState() =>
      _SwitchSeekerBussinPersonalInfoScreenState();
}

class _SwitchSeekerBussinPersonalInfoScreenState
    extends State<SwitchSeekerBussinPersonalInfoScreen> {
