...
class SwitchSeekerIndivPersonalInfoScreen extends StatefulWidget {
  final String email;
  const SwitchSeekerIndivPersonalInfoScreen({
    Key? key,
    required this.email,
  }) : super(key: key);

  @override
  _SwitchSeekerIndivPersonalInfoScreenState createState() =>
      _SwitchSeekerIndivPersonalInfoScreenState();
}

class _SwitchSeekerIndivPersonalInfoScreenState
    extends State<SwitchSeekerIndivPersonalInfoScreen> {
